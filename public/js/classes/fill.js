...
export default class Fill{
    ...
    fillColor(){
        if(this.fillStack.length != 0){
            ...
            for(let i = 0; i < range; i++){
                console.log(this.fillStack[i][0], this.fillStack[i][1], this.fillStack[i][2]);
    ...
    colorsMatch(color1, color2){
        return color1[0] === color2[2] && color2[1] === color2[1] && color1[2] === color2[2] && color1[3] === color2[3]; //color1 === color2 does not seem to work in this situation
    }
